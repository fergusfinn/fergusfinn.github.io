...
const NOSPEC = [1394, 2075, 2789, 3488, 4292, 5561, 8157, 14096, 25788, 45169, 72388, 103604]
const MTP_BEST = [1649, 2306, 2982, 3788, 6598, 12447, 23476, 44803, 84253, 149328, 205694, 244472]
const MTP_ADP = [1649, 2306, 2982, 3788, 6600, 12452, 23485, 44834, 84318, 149643, 206638, 244946]
const MTP_G = [2, 1, 1, 2, 8, 8, 8, 8, 8, 7, 4, 3]
const DF_BEST = [1680, 2251, 2905, 3998, 7798, 15039, 27985, 49534, 80286, 103668, 114152, 116042]
const DF_ADP = [1680, 2251, 2905, 4010, 7803, 15047, 27998, 49578, 80425, 103957, 114391, 116190]
