      ...
      <div class="space-y-3">
        <div class="leading-relaxed">
          ...
          <div class="text-base" style="font-family: var(--font-math)">
            2 × {model.numLayers} × {model.numKVHeads} × {model.headDim} = {formatLargeNumber(cachePerToken)} bytes
          </div>
        </div>
        <div class="leading-relaxed">
        ...
        <div class="leading-relaxed">
          ...
          <div class="text-base" style="font-family: var(--font-math)">{formatLargeNumber(model.modelSize * 1e9)} bytes</div>
        </div>
        <div class="leading-relaxed">
