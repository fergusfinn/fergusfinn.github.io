---
title: 'Control Layer Benchmarking'
description: |
  Benchmarking the Doubleword Control Layer
pubDate: 'Oct 22 2025'
slug: control-layer-benchmarking
---
...
gateway around. We believe this because its written in Rust<Sidenote>And
therefore blazing fast</Sidenote>, and because we thought about performance a
...
But we're open sourcing it. And once its out there, it can be used in lots of
different places, in lots of different ways. And so, to prove that it will be
fast everywhere, we have to do benchmarking. <Sidenote> The usual caveats about general case benchmarks apply: the only realistic
...
for interesting content. </Sidenote>
.
...
`dwctl` is an "AI Gateway". For the purposes of this discussion, this is
basically a [reverse
...
This isn't LLM inference optimization<Sidenote>If you care about that sort of
stuff, see
[here](https://fergusfinn.com/blog/scheduling-in-inference-engines/),
[here](http://fergusfinn.com/blog/llm-guided-scheduling/),
[here](http://fergusfinn.com/blog/spacelike-speculative-decoding/),
[here](https://docs.doubleword.ai/conceptual/10-06-2025-bts-2)</Sidenote>,
...
If you'd like to get started with dwctl, join us on the
[github](https://github.com/doublewordai/dwctl). For issues, with our
performance or my benchmarking methodology, raise them on the [issues
page](https://github.com/doublewordai/dwctl/issues).
