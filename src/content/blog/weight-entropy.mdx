...
pubDate: 'May 5 2026'
index: true
coverCredit: 'Henry Briggs, [*Logarithmorum Chilias Prima*](https://commons.wikimedia.org/wiki/File:Logarithmorum_Chilias_Prima_page_0-67.jpg) (1617).'
---
...
weight magnitudes peaked sharply somewhere between $2^{-7}$ and $2^{-6}$ —
...
[>_1]: $\mu$ and $\beta$ are the mean and standard deviation of $\log_2|w|$ for each model. Weights with $|w| < 2^{-16}$ are bucketed into a separate "small" bin (visible at the left edge of the magnitude histogram) and excluded from $\mu$ and $\beta$ so a handful of MoE models with dead expert weights don't distort the collapse.
