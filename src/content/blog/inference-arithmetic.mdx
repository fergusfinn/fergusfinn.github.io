...
of FLOPS for an individual matmul is $2 \times \# \mathrm{parameters}$<Sidenote>We ignore the embedding parameters, since those don't actually get matrix multiplied.</Sidenote>, then we
